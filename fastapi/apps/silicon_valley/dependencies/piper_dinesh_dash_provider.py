...
from silicon_valley.adapter.outbound.repository.piper_dinesh_dash_repository import DineshDashRepository
...
from silicon_valley.app.use_cases.dinesh_dash_interactor import DineshDashInteractor
